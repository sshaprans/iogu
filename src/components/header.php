        ...
        <div class="header-up">
            ...
            <div class="header-up__title-wrapper">
                ...
                <h2 class="header-up__title">
                    <!-- ВИКОРИСТОВУЄМО ЗНАЧЕННЯ З БД АБО ДЕФОЛТНЕ -->
                    <!-- Ми шукаємо ключ 'site_title' в групі 'general' -->
                    <?= $configGroups['general']['site_title'] ?? t('site_title') ?>
                </h2>
            </div>
            <div class="header-up__ui-wrapper">
                ...
                <ul class="header-up__social-list">
                    ...
                    <li class="header-up__social-item">
                        <a href="<?= $configGroups['social']['social_facebook'] ?? '11https://www.facebook.com/iogu.gov.ua' ?>" target="_blank" class="header-up__social-link">
                    ...
                    <li class="header-up__social-item">
                        <a href="<?= $configGroups['social']['social_viber'] ?? '11viber://chat?number=%2B380930138074' ?>" target="_blank" class="header-up__social-link">
                    ...
                    <li class="header-up__social-item">
                        <a href="<?= $configGroups['social']['social_whatsapp'] ?? '11https://wa.me/380930138074' ?>" target="_blank" class="header-up__social-link">
                            <svg class="header-social" width="30" height="30" viewBox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
