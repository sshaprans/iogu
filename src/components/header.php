...
try {
    ...
    $stmt = $db->query("SELECT key_name, value_uk, value_en, group_name FROM settings");
    $settings = $stmt->fetchAll(PDO::FETCH_ASSOC);

    $currentLang = 'uk';
    if ((function_exists('is_lang_active') && is_lang_active('en')) || (isset($_GET['lang']) && $_GET['lang'] === 'en')) {
        $currentLang = 'en';
    }

    $valKey = 'value_' . $currentLang;

    foreach ($settings as $item) {
        $group = $item['group_name'] ?: 'general';
        $key = $item['key_name'];
        $value = $item[$valKey] ?: ($item['value_uk'] ?? '');
    ...
    <div class="header-wrap">
        ...
        <div class="header-down">
            ...
            <h2 class="header-up__title--mob">
                <?= $configGroups['general']['site_title'] ?? t('site_title_main') ?>
            </h2>
            <nav class="nav" role="navigation" aria-label="<?= htmlspecialchars(t('header.aria_main_menu')) ?>">
                <ul class="nav__menu">
                    <li class="mobile-lang">
                        <div class="lang-item header-link <?= (function_exists('is_lang_active') && is_lang_active('uk')) ? 'active' : '' ?>" data-lang="uk">
                            Укр
                        </div>
                        <div class="lang-item header-link <?= (function_exists('is_lang_active') && is_lang_active('en')) ? 'active' : '' ?>" data-lang="en">
                            Eng
                        </div>
                    </li>
                    <li class="nav__item nav__item--has-submenu">
                        ...
                        <svg class="nav__link-svg" width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 8L9.33013 0.5H0.669873L5 8Z" fill="white"/>
                        </svg>
                        <ul class="nav__submenu">
                            <li class="nav__submenu__item"><a href="<?= base_url('/history') ?>" class="nav__submenu__link"><?= t('header.menu.history') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/leadership') ?>" class="nav__submenu__link" ><?= t('header.menu.leadership') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/structure') ?>" class="nav__submenu__link" ><?= t('header.menu.structure') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/activity') ?>" class="nav__submenu__link" ><?= t('header.menu.activity') ?></a></li>
                            <li class="nav__submenu__item"><a href="https://media.iogu.gov.ua/img/position.pdf" target="_blank" class="nav__submenu__link" ><?= t('header.menu.position') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/anticorruption') ?>" class="nav__submenu__link" ><?= t('header.menu.anticorruption') ?></a></li>
                        </ul>
                    </li>
                    <li class="nav__item nav__item--has-submenu">
                        ...
                        <ul class="nav__submenu">
                            <li class="nav__submenu__item"><a href="<?= base_url('/ground_partner') ?>" class="nav__submenu__link" ><?= t('header.menu.gr_partner') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/land_survey') ?>" class="nav__submenu__link" ><?= t('header.menu.land_survey') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/monitoring_objects') ?>" class="nav__submenu__link" ><?= t('header.menu.monitoring') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/edition') ?>" class="nav__submenu__link" ><?= t('header.menu.edition') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/international_activity') ?>" class="nav__submenu__link" ><?= t('header.intern_activity') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/government_procurement') ?>" class="nav__submenu__link" ><?= t('header.menu.procurement') ?></a></li>
                        </ul>
                    </li>
                    <li class="nav__item nav__item--has-submenu">
                        ...
                        <ul class="nav__submenu">
                            <li class="nav__submenu__item"><a href="<?= base_url('/news') ?>" class="nav__submenu__link" ><?= t('header.menu.news') ?></a></li>
                            <li class="nav__submenu__item"><a href="<?= base_url('/photo_gallery') ?>" class="nav__submenu__link"><?= t('header.menu.photo_gal') ?></a></li>
                        </ul>
                    </li>
                    <li class="nav__item"><a href="<?= base_url('/branches') ?>" class="nav__link" ><?= t('header.menu.branches') ?></a></li>
                    <li class="nav__item"><a href="<?= base_url('/npa') ?>" class="nav__link" ><?= t('header.menu.npa') ?></a></li>
                    <li class="nav__item"><a href="<?= base_url('/contacts') ?>" class="nav__link" ><?= t('header.menu.contact') ?></a></li>
                </ul>
            </nav>
            <div class="lang_wrap">
                <svg class="lang_icon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M23.6001 12.3H1.1001" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12.3 23.6C18.5408 23.6 23.6 18.5408 23.6 12.3C23.6 6.05918 18.5408 1 12.3 1C6.05918 1 1 6.05918 1 12.3C1 18.5408 6.05918 23.6 12.3 23.6Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12.3001 23.6C15.4481 23.6 18.0001 18.5408 18.0001 12.3C18.0001 6.05918 15.4481 1 12.3001 1C9.15207 1 6.6001 6.05918 6.6001 12.3C6.6001 18.5408 9.15207 23.6 12.3001 23.6Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M21.9 6.60001H2.69995" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M21.9 18H2.69995" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12.3 23.6V1.10001" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <ul class="lang-list">
                    <li class="lang-item header-link <?= (function_exists('is_lang_active') && is_lang_active('uk')) ? 'active' : '' ?>" data-lang="uk">Укр</li>
                    <li class="lang-item header-link <?= (function_exists('is_lang_active') && is_lang_active('en')) ? 'active' : '' ?>" data-lang="en">Eng</li>
                </ul>
            </div>
