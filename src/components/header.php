            ...
            <div class="header-up__ui-wrapper">
                ...
                <ul class="header-up__social-list">
                    <li class="header-up__social-item">
                        <a href="https://www.facebook.com/iogu.gov.ua" target="_blank" class="header-up__social-link">
                    ...
                    <li class="header-up__social-item">
                        <a href="https://t.me/+380930138074" target="_blank" class="header-up__social-link">
                            <svg class="header-social" width="30" height="30" viewBox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="header-up__social-item">
                        <a href="viber://chat?number=%2B380930138074" target="_blank" class="header-up__social-link">
                            <svg class="header-social" width="30" height="30" viewBox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="header-up__social-item">
                        <a href="https://wa.me/380930138074" target="_blank" class="header-up__social-link">
                            <svg class="header-social" width="30" height="30" viewBox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
